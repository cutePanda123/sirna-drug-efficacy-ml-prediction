...
gene_target_symbol_name_category = ['ABLIM3', 'ACE2', 'ADRA2A', 'ANGPTL3', 'ANGPTL4', 'ANGPTL7', 'APP',
       ...
       'Gsk3a', 'HAO1', 'HMGCR', 'Hao1', 'KHK', 'LDHA', 'Ldha', 'MAPT',
       'MUC5B', 'Mtarc1', 'Muc5b', 'PRNP', 'PRODH2', 'SCD5', 'SCN9A', 'SLC5A2',
       'SOD1', 'Sod1', 'TMPRSS2', 'TMPRSS6', 'TTR']
...
gene_target_species_category = ['Homo sapiens', 'Macaca fascicularis', 'Mus musculus']

Transfection_method_category = ['Free uptake', 'Lipofectamine']

Duration_after_transfection_h_category = [24.0, 48.0]
